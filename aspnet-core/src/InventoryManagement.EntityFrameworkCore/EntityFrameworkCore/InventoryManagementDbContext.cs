...
namespace InventoryManagement.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See InventoryManagementMigrationsDbContext for migrations.
     */
    ...
    public class InventoryManagementDbContext : AbpDbContext<InventoryManagementDbContext>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<AppUser>(b =>
            {
                 ...
                 * Also see the InventoryManagementEfCoreEntityExtensionMappings class
                 */
            });
