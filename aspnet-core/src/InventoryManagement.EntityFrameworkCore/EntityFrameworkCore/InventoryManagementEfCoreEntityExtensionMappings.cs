...
{
    public static class InventoryManagementEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE InventoryManagementModuleExtensionConfigurator CLASS (in the Domain.Shared project)
